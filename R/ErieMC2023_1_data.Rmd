...
eriedata$Month <- as.numeric(format(eriedata$Rdate, "%m"))
...
eriedata$Weeks <- as.numeric(format.Date(eriedata$Rdate, format="%W"))
eriedata$BiWeek <- floor(eriedata$Weeks/2)

save(eriedata , file=paste(saveDIR, "eriedataClean.RData", sep="/"))
```
